...
SELECT ecodCelular AS Codigo from bitcelular where tcelular = telefono;
END if;
end$$
...
insert into bitcorreos(`tcorreo`)
values (tCorreov);
SELECT  LAST_INSERT_ID() AS Codigo;
else

SELECT ecodCorreo AS Codigo from bitcorreos where tcorreo = tCorreov;
UPDATE bitcorreos set tcorreo = tCorreov where ecodCorreo = Codigomail;
END if;
end$$
...
insert into bitviajes(`treferencia`,`tpedido`,`ecodProvedor`,`tOrigen`,`tDestino`,`fhSalida`,`fhLlegada`,`ecodOperados`,`ecodCliente`,`EcodEstatus`,`tmonitoreo`,`tTipoViaje`,`tTipoGasto`,`Link`)
values (treferenciav, tpedidov,ecodProvedorv,tOrigenv,tDestinov,fhSalidav,fhLlegadav,ecodOperadosv,ecodClientev,EcodEstatusv,tmonitoreov,tTipoViajev,tTipoGastov,Linkv);
SELECT  LAST_INSERT_ID() AS Codigo;

else
SELECT ecodViajev AS Codigo;
UPDATE bitviajes set tTipoViaje=tTipoViajev,tTipoGasto=tTipoGastov, ecodProvedor=ecodProvedorv,treferencia=treferenciav,tpedido=tpedidov,tOrigen=tOrigenv,tDestino=tDestinov,fhSalida=fhSalidav,fhLlegada=fhLlegadav,ecodOperados=ecodOperadosv,ecodCliente=ecodClientev,EcodEstatus=EcodEstatusv,tmonitoreo=tmonitoreov, Link = Linkv where ecodViaje = ecodViajev;
...
insert into cattiff(`tTif`,`tNombre`,`tNombreCorto`,`tRFC`,`ecodEstado`,`ecodCiudad`,`ecodCreacion`,`fhCreacion`,ecodEstatus,tcp,tDireccion)
values (tTiffv,tNombrev,tNombreCortov,tRFCv,ecodEstadov,ecodCiudadv,loginEcodUsuarios,NOW(),ecodEstatusv,tCPv,tDireccionv );
SELECT  LAST_INSERT_ID() AS Codigo;

ELSE

	
	SELECT ecodTiffv AS Codigo;

UPDATE cattiff SET tcp = tCPv, tDireccion = tDireccionv, ecodEstatus = ecodEstatusv, tTif = tTiffv, tNombre = tNombrev, tNombreCorto = tNombreCortov, tRFC = tRFCv,ecodEstado = ecodEstadov, ecodCiudad = ecodCiudadv,ecodEdicion=loginEcodUsuarios,fhEdicion=NOW()
WHERE
	ecodTif = ecodTiffv;
...
SELECT ecodUsuarioCelular AS Codigo from relusuariocelular WHERE ecodUsuario = ecodCliente AND ecodCelular = codigoCel;
END if;
end$$
...
insert into relusuariocorreo(`ecodUsuario`,`ecodCorreo`)
values (ecodCliente,codigoCoreeo);
SELECT  LAST_INSERT_ID() AS Codigo;

else

SELECT ecodUsuarioCorreo  AS Codigo from relusuariocorreo WHERE ecodUsuario = ecodCliente AND ecodCorreo = codigoCoreeo;
END if;
end$$
...
insert into catusuarios(`ecodUsuarios`,`trfc`, `tNombre`, `tApellido`,`fCreacion`,`EcodEstatus`,`ecodCreacion`)
values (ecodUsuariosv,tRFCv,tNombrev,tApellidov,NOW(),EcodEstatusv,loginEcodUsuarios);

SELECT  ecodUsuariosv AS Codigo;
else

SELECT ecodUsuarios AS Codigo from catusuarios where ecodUsuarios = ecodUsuariosv;
UPDATE catusuarios set tRFC=tRFCv,tNombre = tNombrev, tApellido=tApellidov,ecoEdicion=loginEcodUsuarios,fhEdicion=NOW() where ecodUsuarios =ecodUsuariosv;
...
SELECT 'viaje no encontrado';

else
SELECT ecodViajev AS Codigo;
UPDATE bitviajes set tmonitoreo = tmonitoreov where ecodViaje = ecodViajev;
...
--
-- Estructura de tabla para la tabla `bitcelular`
--
...
INSERT INTO `bitcelular` (`ecodCelular`, `tcelular`) VALUES
(41, '3141970232');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bitcorreos`
--
...
INSERT INTO `bitcorreos` (`ecodCorreo`, `tcorreo`, `tpassword`, `token`) VALUES
(35, 'admin@gmail.com', 'admin', NULL),
(38, 'operador@gmail.com', 'operador', NULL),
(40, 'cliente@gmail.com', 'cliente', NULL),
(41, 'sin@gmail.com', 'sin', NULL),
(61, 'pr@gmail.com', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bitinciadencias`
--
...
CREATE TABLE `bitinciadencias` (
  ...
  `tDestino` varchar(250) DEFAULT NULL,
...
INSERT INTO `bitinciadencias` (`ecodIncidencia`, `ecodViaje`, `treferencia`, `tpedido`, `tDestino`, `tOrigen`, `ecodOperados`, `ecodCliente`, `EcodEstatus`, `fhSalida`, `fhLlegada`, `tmonitoreo`, `tIncidentes`, `ecodEdicion`, `fhEdicion`, `ecodProvedor`, `tTipoViaje`, `tTipoGasto`, `Link`) VALUES
(12, '82', 'ALT22-00983', 'TR20427', 'Guadarajara', 'Manzanillo', 'Administrador1', 'Administrador1', 1, '2022-11-16', '2022-11-18', 0, 'data', 'Administrador1', '2022-11-16 09:44:33', 'proveedor', NULL, NULL, NULL),
(13, '85', 'd', 'd', 'd', 'd', 'Administrador1', 'Administrador1', 1, NULL, NULL, 0, NULL, 'Administrador1', '2022-11-17 16:32:48', 'd', 'Destino final nacional', 'Gastos locales', NULL),
(14, '82', 'ALT22-00983', 'TR20427', 'Guadarajara', 'Manzanillo', 'Administrador1', 'Administrador1', 1, '2022-11-16', '2022-11-18', 0, NULL, 'Administrador1', '2022-11-17 16:34:11', 'proveedorw', NULL, NULL, NULL),
(15, '85', 'd', 'd', 'd', 'd', 'Administrador1', 'Administrador1', 1, NULL, NULL, 0, NULL, 'Administrador1', '2022-11-17 17:21:21', 'd', 'Intermedia', 'Estadias', NULL),
(16, '85', 'd', 'd', 'd', 'Tiffsefsefesfesfesfesf', 'Administrador1', 'Administrador1', 1, NULL, NULL, 0, NULL, 'Administrador1', '2022-11-17 17:21:48', 'd', 'Intermedia', 'Estadias', NULL),
(17, '83', 'ALT22-009822', 'TR20427', 'Guadarajara', 'Manzanillo', 'Administrador1', 'Administrador1', 1, '2022-11-17', '2022-11-19', 1, 'datos dañados porque si', 'Administrador1', '2022-11-17 17:26:16', NULL, NULL, NULL, NULL),
(18, '83', 'ALT22-009822', 'TR20427', 'Guadarajara', 'Manzanillo', 'Administrador1', 'Administrador1', 1, '2022-11-17', '2022-11-19', 0, NULL, 'Administrador1', '2022-11-17 17:37:23', NULL, 'Destino final nacional', 'Gastos locales', NULL),
(19, '87', 'ALT22-00999', 'TR20427', 'dwa', 'dwa', '13cceb28-91c9-4005-b3df-d60978cd5d85', '13cceb28-91c9-4005-b3df-d60978cd5d85', 2, NULL, NULL, 0, NULL, 'Administrador1', '2022-11-24 13:44:30', 'a', 'Destino final nacional', 'Gastos locales', 'dwadwadawdawdw'),
(20, '86', 'ALT22-009E4', 'TR20427', 'casc', 'Manzanillo', '13cceb28-91c9-4005-b3df-d60978cd5d85', 'Administrador1', 1, '2022-11-24', '2022-11-25', 0, NULL, 'Administrador1', '2022-11-24 13:53:14', 'cscacasc', 'Origen nacional', 'Gastos locales', NULL),
(21, '86', 'ALT22-009E4', 'TR20427', 'casc', 'Manzanillo', '13cceb28-91c9-4005-b3df-d60978cd5d85', 'Administrador1', 3, '2022-11-24', '2022-11-25', 0, NULL, 'Administrador1', '2022-11-24 13:59:40', 'cscacasc', 'Origen nacional', 'Gastos locales', NULL),
(22, '85', 'd', 'd', 'ddasdawdwadwadw', 'Tiffsefsefesfesfesfesf', 'Administrador1', 'Administrador1', 1, NULL, NULL, 0, NULL, 'Administrador1', '2022-11-24 14:00:02', 'd', 'Intermedia', 'Estadias', NULL),
(23, '91', 'dEQDqd', 'qadwf', 'dawdwa', '8', 'Administrador1', 'Administrador1', 1, '2022-11-26', '2022-11-18', 0, NULL, 'Administrador1', '2022-11-25 17:55:31', 'dwad', 'Origen nacional', 'Gastos locales', 'wadwa'),
(24, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 13:13:17', NULL, NULL, NULL, 'wdaw'),
(25, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 13:13:30', NULL, NULL, NULL, 'wdaw'),
(26, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 13:16:17', NULL, NULL, NULL, 'wdaw'),
(27, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 13:19:08', NULL, NULL, NULL, 'wdaw'),
(28, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 13:19:22', NULL, NULL, NULL, 'wdaw'),
(29, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, 'LA llanta se poncho', 'Administrador1', '2022-11-28 16:11:04', NULL, NULL, NULL, 'wdaw'),
(30, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 16:19:49', NULL, NULL, NULL, 'wdaw'),
(31, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 16:20:18', NULL, NULL, NULL, 'wdaw'),
(32, '92', 'dwad', 'dwadwa', '8', '6', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 16:20:45', NULL, NULL, NULL, 'wdaw'),
(33, '91', 'dEQDqd', 'qadwf', 'dawdwa', '7', 'Administrador1', 'Administrador1', 1, '2022-11-26', '2022-11-18', 0, NULL, 'Administrador1', '2022-11-28 16:31:36', 'dwad', 'Origen nacional', 'Gastos locales', 'wadwa'),
(34, '92', 'dwad', 'dwadwa', '7', '8', 'Administrador1', '13cceb28-91c9-4005-b3df-d60978cd5d85', 1, '2022-11-26', '2022-11-26', 0, NULL, 'Administrador1', '2022-11-28 17:11:29', NULL, NULL, NULL, 'wdaw');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bitmensaje`
--
...
INSERT INTO `bitmensaje` (`ecodMensaje`, `tMensaje`, `fhSalida`) VALUES
(430, 's', '2022-11-04 17:47:58'),
(431, 's', '2022-11-04 17:47:58'),
(432, 'sfs', '2022-11-04 17:48:53'),
(433, 'fesf', '2022-11-04 17:48:53'),
(434, 'dsa', '2022-11-04 17:49:58'),
(435, 'dsad', '2022-11-04 17:49:58'),
(436, 'fesfewsfsfse', '2022-11-04 17:54:00'),
(437, 'saliento', '2022-11-04 17:54:16'),
(438, 'saliento', '2022-11-04 17:54:16'),
(439, 'cawdwad', '2022-11-08 13:04:38'),
(440, 'cawdwad', '2022-11-08 13:05:50'),
(441, 'ddawdwad', '2022-11-08 13:07:24'),
(442, 'awdawdawd', '2022-11-08 13:07:24'),
(443, '}\n}\noo', '2022-11-09 10:06:38'),
(444, '}\n}\noo', '2022-11-09 10:07:57'),
(445, 'fsefesfs', '2022-11-10 11:44:51'),
(446, 'wafwaf', '2022-11-10 12:05:03'),
(447, 'awdwadwadwafwffwa', '2022-11-10 12:05:23'),
(448, 'awdwadwadwafwffwa', '2022-11-10 12:05:23'),
(449, 'awdwadwadwafwffwa', '2022-11-10 12:05:23'),
(450, 'awdwadwadwafwffwa', '2022-11-10 12:05:23'),
(451, 'awdwadwadwafwffwa', '2022-11-10 12:05:23'),
(452, 'cc', '2022-11-10 12:15:34'),
(453, 'cc', '2022-11-10 12:15:34'),
(454, 'cc', '2022-11-10 12:15:34'),
(455, 'cc', '2022-11-10 12:15:34'),
(456, 'cc', '2022-11-10 12:15:34'),
(457, 'dawdwa', '2022-11-10 12:40:39'),
(458, 'sdwadwa', '2022-11-10 12:40:58'),
(459, 'dasdwdawd', '2022-11-10 12:41:21'),
(460, 'dwadwadawdawdwaf', '2022-11-10 13:15:53'),
(461, NULL, '2022-11-10 13:15:53'),
(462, NULL, '2022-11-10 13:15:53'),
(463, NULL, '2022-11-10 13:15:53'),
(464, NULL, '2022-11-10 13:15:53'),
(465, NULL, '2022-11-12 10:05:52'),
(466, NULL, '2022-11-12 10:05:52'),
(467, NULL, '2022-11-12 10:05:52'),
(468, NULL, '2022-11-12 10:05:52'),
(469, NULL, '2022-11-12 10:05:52'),
(470, NULL, '2022-11-12 10:05:52');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bitviajes`
--
...
--
-- Estructura de tabla para la tabla `catcontroller`
--
...
INSERT INTO `catcontroller` (`ecodController`, `tNombre`, `url`) VALUES
(1, 'Nuevo viaje', 'Operaciones/viaje/nuevoViaje'),
(2, 'Monitor de viajes', 'Operaciones/viaje/monitoreoViajes'),
(3, 'Usuarios registro', 'Consulta/Usuario/Registrar'),
(4, 'AsignacionPermisos', 'Consulta/Usuario/AsignacionPermisos'),
(5, 'EliminarUsuario', 'Consulta/Usuario/Eliminar'),
(6, 'Registrar Tiff', 'Catalogo/TIFF/Registro'),
(7, 'Documentacion de viajes', 'Operaciones/viaje/DocumentsViajes');
...
INSERT INTO `catestados` (`ecodEstado`, `tNombre`) VALUES
(1, 'Aguascalientes'),
(2, 'Baja California'),
...
INSERT INTO `catmenu` (`ecodMenu`, `tNombre`) VALUES
(1, 'Catalogo'),
(2, 'Operaciones'),
(3, 'Sistemas');
...
INSERT INTO `catmunicipios` (`ecodMunicipio`, `tNombre`) VALUES
(1, 'Aguascalientes'),
...
--
-- Estructura de tabla para la tabla `catpermisos`
--
...
INSERT INTO `catpermisos` (`ecodPermisos`, `tNombre`, `tNombreCorto`) VALUES
(1, 'Leer', 'R'),
(2, 'Clear', 'C'),
(3, 'Eliminar', 'D');
...
INSERT INTO `catsubmenu` (`ecodSubMenu`, `tNombre`, `url`) VALUES
(4, 'Usuarios', 'Catalogo/usuarios/Consulta'),
(5, 'Viajes', 'Operaciones/viaje/consulta'),
(6, 'Tipo de transporte', 'Catalogo/TipoTransportes/Consulta'),
(7, 'Usuarios', 'Sistemas/usuarios/Consulta'),
(8, 'Menu SubMenus', 'Catalogo/MenuSubmenu/Consulta'),
(9, 'Empresas', 'Catalogo/Empresas/consulta'),
(11, 'Ciudades Entidades', 'Catalogo/CiudadesEntidades/Consulta'),
(12, 'TIFF', 'Catalogo/TIFF/Consulta');
...
INSERT INTO `cattipousuario` (`ecotTipoUsuario`, `tNombre`) VALUES
(1, 'Agente'),
(2, 'Cliente'),
(3, 'Operador'),
(4, 'Tramitador'),
...
INSERT INTO `catusuarios` (`ecodUsuarios`, `trfc`, `tNombre`, `tApellido`, `fCreacion`, `EcodEstatus`, `ecodTipoUsuario`, `ecodEliminacion`, `fhEliminacion`, `tMotivoEliminacion`, `ecodCreacion`, `ecoEdicion`, `fhEdicion`) VALUES
('13cceb28-91c9-4005-b3df-d60978cd5d85', 'OPEC0001112RA', 'operador', 'apeoperador', '2022-11-02', 1, 3, NULL, NULL, NULL, NULL, 'Administrador1', '2022-11-02 11:59:44'),
...
--
-- Estructura de tabla para la tabla `relestadosmunicipios`
--
...
INSERT INTO `relestadosmunicipios` (`ecodestadosmunicipios`, `ecodestados`, `ecodmunicipios`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
--
-- Estructura de tabla para la tabla `relmenusubmenu`
--
...
INSERT INTO `relmenusubmenu` (`ecosMenuSubmenu`, `ecodSubmenu`, `ecodMenu`, `ecodController`) VALUES
(4, 5, 2, 1),
(5, 5, 2, 2),
(6, 4, 1, 3),
(9, 7, 3, NULL),
...
--
-- Estructura de tabla para la tabla `relusuariocelular`
--
...
INSERT INTO `relusuariocelular` (`ecodUsuarioCelular`, `ecodUsuario`, `ecodCelular`) VALUES
(50, 'Administrador1', 41);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `relusuariocorreo`
--
...
INSERT INTO `relusuariocorreo` (`ecodUsuarioCorreo`, `ecodUsuario`, `ecodCorreo`) VALUES
(39, 'Administrador1', 35),
(42, '13cceb28-91c9-4005-b3df-d60978cd5d85', 38),
(45, '27e7e827-aa07-44db-9164-c0a3afe928bd', 40),
(46, '25bc9de2-0043-4bda-ab9e-24beb36b0914', 41),
(64, '1c5bf5bb-7dd9-45dc-b009-2c77e8638012', 61);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `relusuariosubmenu`
--
...
INSERT INTO `relusuariosubmenu` (`ecodrelusuarioSubMenu`, `ecodUsuario`, `ecodSubMenu`, `ecodMenu`, `ecodPermisos`, `ecodController`) VALUES
(52, 'Administrador1', 4, 1, 3, 3),
(53, '13cceb28-91c9-4005-b3df-d60978cd5d85', 5, 2, 1, NULL),
(54, 'Administrador1', 5, 2, 3, 1),
(55, '27e7e827-aa07-44db-9164-c0a3afe928bd', 5, 2, 1, NULL),
(56, 'Administrador1', 7, 3, 3, 4),
(57, 'Administrador1', 4, 1, 3, 5),
(58, 'Administrador1', 5, 2, 3, 2),
(59, 'Administrador1', 8, 1, 3, NULL),
(60, 'Administrador1', 11, 1, 3, NULL),
(61, 'Administrador1', 12, 1, 2, 6),
(62, 'Administrador1', 5, 2, 3, 7),
(63, '13cceb28-91c9-4005-b3df-d60978cd5d85', 5, 2, 1, 7);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `relviajedocumentos`
--
...
--
-- Estructura de tabla para la tabla `relviajemensaje`
--
...
--
-- Indices de la tabla `bitcelular`
--
ALTER TABLE `bitcelular`
  ADD PRIMARY KEY (`ecodCelular`);

--
-- Indices de la tabla `bitcorreos`
--
ALTER TABLE `bitcorreos`
  ADD PRIMARY KEY (`ecodCorreo`);

--
-- Indices de la tabla `bitinciadencias`
--
ALTER TABLE `bitinciadencias`
  ADD PRIMARY KEY (`ecodIncidencia`),
  ADD KEY `ecodOperados` (`ecodOperados`),
  ADD KEY `ecodCliente` (`ecodCliente`),
  ADD KEY `EcodEstatus` (`EcodEstatus`);

--
-- Indices de la tabla `bitmensaje`
--
ALTER TABLE `bitmensaje`
  ADD PRIMARY KEY (`ecodMensaje`);

--
-- Indices de la tabla `bitviajes`
--
ALTER TABLE `bitviajes`
  ADD PRIMARY KEY (`ecodViaje`),
  ADD KEY `ecodOperados` (`ecodOperados`),
  ADD KEY `ecodCliente` (`ecodCliente`),
  ADD KEY `EcodEstatus` (`EcodEstatus`),
...
--
-- Indices de la tabla `catcontroller`
--
ALTER TABLE `catcontroller`
  ADD PRIMARY KEY (`ecodController`);
...
--
-- Indices de la tabla `catpermisos`
--
ALTER TABLE `catpermisos`
  ADD PRIMARY KEY (`ecodPermisos`);
...
ALTER TABLE `cattipousuario`
  ADD PRIMARY KEY (`ecotTipoUsuario`);

--
-- Indices de la tabla `catusuarios`
--
ALTER TABLE `catusuarios`
  ADD PRIMARY KEY (`ecodUsuarios`),
  ADD KEY `EcodEstatus` (`EcodEstatus`),
  ADD KEY `ecodTipoUsuario` (`ecodTipoUsuario`),
  ADD KEY `ecodTipoUsuario_2` (`ecodTipoUsuario`);
...
--
-- Indices de la tabla `relmenusubmenu`
--
ALTER TABLE `relmenusubmenu`
  ADD PRIMARY KEY (`ecosMenuSubmenu`),
  ADD KEY `ecodMenu` (`ecodMenu`),
  ADD KEY `ecodSubmenu` (`ecodSubmenu`),
  ADD KEY `ecodController` (`ecodController`);

--
-- Indices de la tabla `relusuariocelular`
--
ALTER TABLE `relusuariocelular`
  ADD PRIMARY KEY (`ecodUsuarioCelular`),
  ADD KEY `ecodUsuario` (`ecodUsuario`),
  ADD KEY `ecodCelular` (`ecodCelular`);

--
-- Indices de la tabla `relusuariocorreo`
--
ALTER TABLE `relusuariocorreo`
  ADD PRIMARY KEY (`ecodUsuarioCorreo`),
  ADD KEY `ecodUsuario` (`ecodUsuario`),
  ADD KEY `ecodCorreo` (`ecodCorreo`);

--
-- Indices de la tabla `relusuariosubmenu`
--
ALTER TABLE `relusuariosubmenu`
  ADD PRIMARY KEY (`ecodrelusuarioSubMenu`),
  ADD KEY `ecodUsuario` (`ecodUsuario`),
  ADD KEY `ecodSubMenu` (`ecodSubMenu`),
  ADD KEY `ecodMenu` (`ecodMenu`),
  ADD KEY `ecodPermisos` (`ecodPermisos`),
  ADD KEY `ecotController` (`ecodController`),
  ADD KEY `ecodUsuario_2` (`ecodUsuario`);

--
-- Indices de la tabla `relviajedocumentos`
--
ALTER TABLE `relviajedocumentos`
  ADD PRIMARY KEY (`ecodrelViajeDocumentos`),
  ADD KEY `ecodViaje` (`ecodViaje`),
  ADD KEY `ecodDocumento` (`ecodDocumento`);

--
-- Indices de la tabla `relviajemensaje`
--
ALTER TABLE `relviajemensaje`
  ADD PRIMARY KEY (`ecodviajeMensaje`),
  ADD KEY `ecodViaje` (`ecodViaje`),
  ADD KEY `ecodMensaje` (`ecodMensaje`);
...
--
-- Filtros para la tabla `bitviajes`
--
ALTER TABLE `bitviajes`
  ADD CONSTRAINT `bitviajes_ibfk_3` FOREIGN KEY (`EcodEstatus`) REFERENCES `catestatus` (`EcodEstatus`);
...
--
ALTER TABLE `catusuarios`
  ADD CONSTRAINT `catusuarios_ibfk_1` FOREIGN KEY (`EcodEstatus`) REFERENCES `catestatus` (`EcodEstatus`),
  ADD CONSTRAINT `catusuarios_ibfk_2` FOREIGN KEY (`ecodTipoUsuario`) REFERENCES `cattipousuario` (`ecotTipoUsuario`);

--
-- Filtros para la tabla `relestadosmunicipios`
--
ALTER TABLE `relestadosmunicipios`
  ADD CONSTRAINT `relestadosmunicipios_ibfk_1` FOREIGN KEY (`ecodestados`) REFERENCES `catestados` (`ecodEstado`),
  ADD CONSTRAINT `relestadosmunicipios_ibfk_2` FOREIGN KEY (`ecodmunicipios`) REFERENCES `catmunicipios` (`ecodMunicipio`);

--
-- Filtros para la tabla `relmenusubmenu`
--
ALTER TABLE `relmenusubmenu`
  ADD CONSTRAINT `relmenusubmenu_ibfk_1` FOREIGN KEY (`ecodMenu`) REFERENCES `catmenu` (`ecodMenu`),
  ADD CONSTRAINT `relmenusubmenu_ibfk_2` FOREIGN KEY (`ecodSubmenu`) REFERENCES `catsubmenu` (`ecodSubMenu`),
  ADD CONSTRAINT `relmenusubmenu_ibfk_3` FOREIGN KEY (`ecodController`) REFERENCES `catcontroller` (`ecodController`);

--
-- Filtros para la tabla `relusuariocelular`
--
ALTER TABLE `relusuariocelular`
  ADD CONSTRAINT `relusuariocelular_ibfk_2` FOREIGN KEY (`ecodCelular`) REFERENCES `bitcelular` (`ecodCelular`);

--
-- Filtros para la tabla `relusuariocorreo`
--
ALTER TABLE `relusuariocorreo`
  ADD CONSTRAINT `relusuariocorreo_ibfk_2` FOREIGN KEY (`ecodCorreo`) REFERENCES `bitcorreos` (`ecodCorreo`);

--
-- Filtros para la tabla `relusuariosubmenu`
--
ALTER TABLE `relusuariosubmenu`
  ADD CONSTRAINT `relusuariosubmenu_ibfk_2` FOREIGN KEY (`ecodSubMenu`) REFERENCES `catsubmenu` (`ecodSubMenu`),
  ADD CONSTRAINT `relusuariosubmenu_ibfk_3` FOREIGN KEY (`ecodMenu`) REFERENCES `catmenu` (`ecodMenu`),
  ADD CONSTRAINT `relusuariosubmenu_ibfk_4` FOREIGN KEY (`ecodPermisos`) REFERENCES `catpermisos` (`ecodPermisos`),
  ADD CONSTRAINT `relusuariosubmenu_ibfk_5` FOREIGN KEY (`ecodController`) REFERENCES `catcontroller` (`ecodController`),
  ADD CONSTRAINT `relusuariosubmenu_ibfk_6` FOREIGN KEY (`ecodUsuario`) REFERENCES `catusuarios` (`ecodUsuarios`);

--
-- Filtros para la tabla `relviajedocumentos`
--
ALTER TABLE `relviajedocumentos`
  ADD CONSTRAINT `relviajedocumentos_ibfk_1` FOREIGN KEY (`ecodViaje`) REFERENCES `bitviajes` (`ecodViaje`),
  ADD CONSTRAINT `relviajedocumentos_ibfk_2` FOREIGN KEY (`ecodDocumento`) REFERENCES `catdocumentos` (`ecodDocumentos`);

--
-- Filtros para la tabla `relviajemensaje`
--
ALTER TABLE `relviajemensaje`
  ADD CONSTRAINT `relviajemensaje_ibfk_1` FOREIGN KEY (`ecodViaje`) REFERENCES `bitviajes` (`ecodViaje`),
  ADD CONSTRAINT `relviajemensaje_ibfk_2` FOREIGN KEY (`ecodMensaje`) REFERENCES `bitmensaje` (`ecodMensaje`);
COMMIT;
